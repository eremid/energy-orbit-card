...
/**
 * Energy Orbit Card V1.0.1 - Rounded Bars & Custom Colors
 * @version 1.0.1
 * 
 * Changelog:
...
console.info("%c ENERGY-ORBIT-CARD %c 1.0.1 ", "color:white;background:#FF6B35", "color:white;background:#1a2332");
